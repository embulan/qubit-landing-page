...
{/* NOTE: when trying to do the redirected sign up, go on the Clerk dashboard to set the redirect link*/}
    ...
    <div className="min-h-screen pt-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 flex flex-col items-center">
        ...
        <SignUp 
          ...
          redirectUrl="/login"  // This will redirect back to sign-in after successful sign-up
        />
      </div>
    </div>
  )
